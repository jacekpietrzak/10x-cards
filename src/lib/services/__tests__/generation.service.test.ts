  ...
  describe("validateFlashcards", () => {
    ...
    describe("Invalid inputs - Type errors", () => {
      it("should throw error for non-array input", () => {
        expect(() => validateFlashcards("not an array")).toThrow(
          "Flashcards must be an array",
        );

        expect(() => validateFlashcards({})).toThrow(
          "Flashcards must be an array",
        );

        expect(() => validateFlashcards(null)).toThrow(
          "Flashcards must be an array",
        );

        expect(() => validateFlashcards(undefined)).toThrow(
          "Flashcards must be an array",
        );
      });
      ...
      it("should throw error for non-object items in array", () => {
        ...
        expect(() => validateFlashcards(cards)).toThrow(
          "Flashcard at index 1 must be an object",
        );
      });
      ...
      it("should throw error for non-string field values", () => {
        ...
        expect(() => validateFlashcards(cards)).toThrow(
          "Flashcard at index 1 must have string values for front and back",
        );
      });
    });
    ...
    describe("Invalid inputs - Missing fields", () => {
      it("should throw error for missing front field", () => {
        ...
        expect(() => validateFlashcards(cards)).toThrow(
          "Flashcard at index 1 missing required fields (front, back)",
        );
      });
    ...
    describe("Invalid inputs - Empty content", () => {
      it("should throw error for empty front text", () => {
        ...
        expect(() => validateFlashcards(cards)).toThrow(
          "Flashcard at index 1 has empty front text",
        );
      });
      ...
      it("should throw error for empty back text", () => {
        ...
        expect(() => validateFlashcards(cards)).toThrow(
          "Flashcard at index 1 has empty back text",
        );
      });
    ...
    describe("Invalid inputs - Array size", () => {
      it("should throw error for less than 3 flashcards", () => {
        ...
        expect(() => validateFlashcards(cards)).toThrow(
          "At least 3 flashcards are required",
        );
      });
    ...
    describe("Invalid inputs - Text length", () => {
      it("should throw error for front text exceeding 200 characters", () => {
        ...
        expect(() => validateFlashcards(cards)).toThrow(
          "Flashcard at index 1 front text exceeds 200 characters (201)",
        );
      });
      ...
      it("should throw error for back text exceeding 500 characters", () => {
        ...
        expect(() => validateFlashcards(cards)).toThrow(
          "Flashcard at index 1 back text exceeds 500 characters (501)",
        );
      });
    });
    ...
    describe("Sanitization", () => {
      it("should remove HTML tags from text", () => {
        const cards = [
          ...
          {
            front: 'Question <script>alert("xss")</script>2',
            back: "Answer 2",
          },
    ...
    describe("Duplicate handling", () => {
      ...
      it("should throw error if less than 3 unique cards after deduplication", () => {
        ...
        expect(() => validateFlashcards(cards)).toThrow(
          "Only 2 unique flashcards after removing duplicates (minimum 3 required)",
        );
      });
    ...
    describe("Edge cases", () => {
      ...
      it("should handle cards with only special characters after sanitization", () => {
        ...
        expect(() => validateFlashcards(cards)).toThrow(
          "Flashcard at index 2 has empty front text after sanitization",
        );
      });
      ...
      it("should handle mixed valid and invalid cards correctly", () => {
        ...
        expect(() => validateFlashcards(cards)).toThrow(
          "Flashcard at index 3 has empty front text",
        );
      });
      ...
      it("should preserve international characters", () => {
        const cards = [
          {
            front: "Pytanie po polsku ąćęłńóśźż",
            back: "Odpowiedź po polsku ĄĆĘŁŃÓŚŹŻ",
          },
