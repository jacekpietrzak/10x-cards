...
create table public.flashcards (
    ...
    constraint fk_generation foreign key (generation_id) references generations(id) on delete
    set null
);
-- Create indexes
...
update on public.flashcards for each row execute function public.handle_updated_at();
-- Comments
